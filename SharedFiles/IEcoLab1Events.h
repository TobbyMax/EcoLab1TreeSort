...
#ifndef __I_ECOLAB1RBTreeEVENTS_H__
#define __I_ECOLAB1RBTreeEVENTS_H__
...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events */
    int16_t(ECOCALLMETHOD* OnPrintTreeCallback)(/* in */ struct IEcoLab1Events* me, /* in */ struct RBNode* root, /* in */ int16_t mode);
    int16_t(ECOCALLMETHOD* OnPrintTreeWithStatusCallback)(/* in */ struct IEcoLab1Events* me,
            /* in */ struct RBNode* root,
            /* in */ struct RBNode* currNode,
            /* in */ int16_t isInserted,
            /* in */ void* p_Element);
    int16_t(ECOCALLMETHOD* OnInorderTreeTraversalCallback)(/* in */ struct IEcoLab1Events* me, /* in */ struct RBNode* root);
...
#endif /* __I_ECOLAB1RBTreeEVENTS_H__ */
